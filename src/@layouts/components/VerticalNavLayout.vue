...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      // 👉 Vertical nav
     const verticalNav = !route.meta.hideNav
      ? (verticalNavWrapper
          ? h(verticalNavWrapper, verticalNavWrapperProps, { default: () => h(
              VerticalNav,
      ...
      return h(
        'div',
        { class: ['layout-wrapper', ...configStore._layoutClasses, { 'layout-hide-vertical-nav': route.meta.hideNav }] },
        [
...
.layout-wrapper.layout-hide-vertical-nav {
  .layout-content-wrapper {
