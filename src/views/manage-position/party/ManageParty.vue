...
import { API_URL, PartyType } from './constants';

const initData: PartyType = {
  title: "",
  agency: "",
  dateEnd: "",
  dateOfficial: "",
...
const page = ref(1)
const dataEdit = ref<PartyType>(initData)
...
const headers: any[] = [
  ...
  { title: 'TÊN ĐẢNG-ĐOÀN THỂ', align: 'left', key: 'title', sortable: false },
        ...
        <VCard>
          ...
          <VCardItem>
            <VRow>
              ...
              <VCol cols="12">
                <AppDateTimePicker v-model="dataEdit.dateOfficial" label="Ngày bổ nhiệm" placeholder="Chọn ngày" />
              </VCol>
