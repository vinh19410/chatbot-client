...
import SynchronousConfiguration from '@/views/pages/account-settings/SynchronousConfiguration.vue'
...
const tabs = [
  ...
  { title: 'Cấu hình đồng bộ', icon: 'tabler-refresh', tab: 'config-sync' },
...
<template>
  <div>
    ...
    <VWindow v-model="activeTab" class="mt-6 disable-tab-transition" :touch="false">
      ...
      <!-- Config Sync -->
      <VWindowItem value="config-sync">
        <SynchronousConfiguration />
      </VWindowItem>
