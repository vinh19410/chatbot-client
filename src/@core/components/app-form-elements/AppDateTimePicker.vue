...
<template>
  <div class="app-picker-field">
    <!-- v-input -->
    <VLabel v-if="fieldProps.label" class="mb-1 text-body-2" style="line-height: 15px;" :for="elementId">
      {{ fieldProps.label }}
        ...
        <VField v-bind="{ ...fieldProps, label: undefined }" :id="id.value" role="textbox"
          ...
          <template #default="{ props: vFieldProps }">
            <div v-bind="vFieldProps">
              <i class="tabler-calendar v-icon" style="block-size: 20px; font-size: 20px;" />
              <!-- flat-picker  -->
              <FlatPickr v-if="!isInlinePicker" v-bind="compAttrs" ref="refFlatPicker" :model-value="modelValue"
                ...
                @on-open="isCalendarOpen = true" @on-close="isCalendarOpen = false"
